package jutils.transport.nio.implement;

import jutils.concurrency.common.ThreadConfig;
import jutils.transport.nio.model.IoContext;
import jutils.transport.nio.model.IoHandler;
import jutils.transport.nio.model.IoProcessor;
...
public class NIOProcessor implements IoProcessor {
    ...
    public NIOProcessor(int noit , ThreadConfig threadConfig)
    {
        ...
        createThreads(threadConfig.copy().setThreadGroup(ioThreadsGroup));
    ...
    {
        this(i, ThreadConfig.newConfig().setMaxPriority().setDaemon(true));
    }
